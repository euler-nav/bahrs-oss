...
#pragma pack(pop)
  ...
  */
  ...
  /**
   * @brief Build time of navigation data message from BAHRS filter output information.
   * @param korBahrsOutput Reference to BAHRS filer output.
   * @return Time of navigation data message.
  */
  STimeOfNavigationDataMessage BuildTimeOfNavigationDataMessage(const NBahrsFilterApi::SOutputData& korBahrsOutput);

  /**
   * @brief Build navigation data accuracy message from BAHRS filter output information.
   * @param korBahrsOutput Reference to BAHRS filter output.
   * @return Accuracy data message.
  */
  SAccuracyDataMessage BuildAccuracyDataMessage(const NBahrsFilterApi::SOutputData& korBahrsOutput);
