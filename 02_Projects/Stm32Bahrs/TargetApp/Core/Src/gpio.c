...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(ICM1_SHDN_GPIO_Port, ICM1_SHDN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MURATA_SHDN_Pin|ICM2_SHDN_Pin|SYNC_ENABLE_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = ICM1_SHDN_Pin|MURATA_RESET_UNO_Pin|NVM_WRITE_CONTROL_Pin;
  ...
  GPIO_InitStruct.Pin = MURATA_SHDN_Pin|RS232_SHDN_Pin|ICM2_SHDN_Pin|SYNC_ENABLE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
