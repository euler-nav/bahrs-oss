...
#define BMP384_REG_INT_STATUS             ((uint8_t)0x11)
#define BMP384_REG_INT_CTRL               ((uint8_t)0x19)
...
#define BMP384_INT_OD                     ((uint8_t)0x01)
#define BMP384_DRDY_EN                    ((uint8_t)(0x01<<6))
#define BMP384_INT_CONF_VALUE             (BMP384_INT_OD | BMP384_DRDY_EN) // Open-drain, Active-low, Interrupt enabled
