...
private:
  explicit CScha63TDriver(SPI_HandleTypeDef& korSpiHandle);
  ~CScha63TDriver() = default;

  /// @brief Get reference to a SPI handle object instantiated in the HAL library.
  /// Returns reference to hspi1 for BAHRS V2 and hspi2 for BAHRS V3.
  /// @return Reference to SPI handle.
