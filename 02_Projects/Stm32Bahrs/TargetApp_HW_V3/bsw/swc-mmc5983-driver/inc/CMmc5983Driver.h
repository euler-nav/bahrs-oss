...
// MMC5983 7-bit I2C address 0x30 (Page 9)
#define MMC5983_I2C_ADDR                    (0x0030 << 1U)
...
#define MMC5983_INT_MEAS_DONE_EN            ((uint8_t)0x04)
#define MMC5983_CM_EN                       ((uint8_t)0x08)

#define MMC5983_18BIT_OFFSET                    (131072.0F)
#define MMC5983_18BIT_SENSITIVITY                (16384.0F)

#define MMC5983_MEAS_M_DONE                 ((uint8_t)0x01)
#define MMC5983_MEAS_T_DONE                 ((uint8_t)0x02)
...
private:
   ...
   * @note: Temperature and magnetic cannot be measured simultaneously
   */
